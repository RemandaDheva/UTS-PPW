...
// Query untuk memuat data gambar webtoon berdasarkan genre yang dipilih
$query = "SELECT * FROM webtoon WHERE genre = 'romansa'";
...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $gambar_webtoon[] = $row['nama_gambar'];
    }
}
?>
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    ...
                    <a href="fantasi.php" class="btn-get-started">Fantasi</a>
                    <a href="romance.php" class="btn-get-started active">Romance</a>
    ...
    <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        <section id="romansa" class="romansa">
            <div class="container-fluid">                
                <div class="row gy-4 justify-content-center">
                    <?php foreach ($gambar_webtoon as $index => $gambar) : ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="spotlight-item h-100">
                                <a href="detail.php?id=<?php echo $index + 4; ?>"><img src="images/<?php echo $gambar; ?>" class="img-fluid" alt=""></a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>

...
// Fungsi untuk menambahkan webtoon ke favorit
function tambahKeFavorit($id_user, $id_webtoon) {
    require 'koneksi.php'; // Sertakan file koneksi

    // Query untuk menambahkan ke favorit
    $query = "INSERT INTO favorit (id_user, id_webtoon) VALUES ($id_user, $id_webtoon)";
    $result = mysqli_query($koneksi, $query);

    if($result) {
        echo "<script>alert('Webtoon berhasil ditambahkan ke favorit');</script>";
    } else {
        echo "<script>alert('Gagal menambahkan webtoon ke favorit');</script>";
    }
}
?>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="header-social-links">
                <a href="super_admin.php" class="search"><i class="bi bi-x-lg"></i></a>
            </div>
        </div>
    </header>
